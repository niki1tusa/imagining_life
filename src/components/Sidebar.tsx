...
export default function Sidebar() {
	...
	return (
		<motion.nav
			...
			className='bg-light-white flex items-center justify-around gap-10 py-3 pr-10 sticky top-4 md:max-h-screen overflow-hidden md:flex-col md:justify-start md:py-0 2xl:text-xl'
		>
